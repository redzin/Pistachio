...
namespace Pistachio
{
  ...
  public:
    ...
    void Render(Device& device, Scene& scene, Camera& camera, uint32_t viewportWidth, uint32_t viewportHeight, PBRMaterialOverrides& shaderOverrides, glm::vec4 clearColor);
